...
logfile = open("blockLogs/down_right_policy.txt", "w")
...
class Down_Right_Policy:
    def __init__(self, blockName):
        ...
        print("initializing down right_policy")
    ...
    def handle_messages(self):
        ...
        for socket in socks:
            ...
            if message['tag'] == 'init_details':
                ...
                #Set up run
                print("down_right_policy initializing run")
            ...
            if self.initialized:
                ...
                if message['tag'] =='state':
                    ...
                    out_message = {"tag": "action", "signal": {'action': action, 'policy_name': 'down_right_policy'}}
...
#------------Initialize
down_right_policy = Down_Right_Policy(blockName)

#----------------------Init zmq-------------------------          
down_right_policy.init_zmq(subTopics, pubTopics)

#-------------Run Loop--------------------
i = 0
print(down_right_policy.blockName, "starting")
keepRunning = True
while keepRunning:
    down_right_policy.handle_messages()
